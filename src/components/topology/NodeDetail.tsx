...
export const NodeDetail = (props: NodeDetailProps): React.ReactElement => {
  ...
  return (
    ...
    >
      ...
      <p>Ping Status: {data?.accessibility_by_network_element__ping_status}</p>
      <p>Snmp Config: {data?.accessibility_by_network_element__snmp_config__name}</p>
      <p>Telnet Status: {data?.accessibility_by_network_element__telnet_status}</p>
      ...
      <p>Sub Domian: {data?.sub_domain}</p>
